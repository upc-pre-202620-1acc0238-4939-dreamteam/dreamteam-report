...
[Conclusiones sobre Problem Statements, Assumptions vs. comportamiento real,
Hypothesis Statements y criterios de éxito, contrastados con resultados de
validación. Recomendaciones sobre roadmap.]
...
`upc-pre-<periodo>-1acc0238-<NRC>-<startup>-performance-<avn/tbn>`

## Anexo C. Términos y Condiciones de Servicio

[Redacción de T&C — enlazados en footer del Landing Page y en registro de cuenta en
la app]

El contenido del servicio debe describir el uso de DNI y foto del rostro para el registro, el carácter privado de las fotos, la finalidad separada de la evidencia del incidente y la ubicación del pasajero durante el viaje para detectar su salida. Debe explicar que las solicitudes de pasajeros requieren mensaje, foto, tres cuentas distintas en cinco minutos y aprobación empresarial; el botón del conductor genera una emergencia directa y prioritaria. La ubicación se detiene al finalizar el viaje y el usuario dispone de cierre manual. El historial compartido del bus no incluye identidades ni evidencia privada. Estos puntos describen el funcionamiento documentado y no constituyen una afirmación de verificación oficial de identidad.
...
**Cliente(s):** [Participantes de la sesión]
**Site/App a evaluar:** [completar]

### Tareas a evaluar

1. Completar registro del pasajero con DNI y foto del rostro e iniciar un viaje mediante QR.
2. Consultar alertas del bus y distinguir solicitud, aprobación y emergencia activa.
3. Enviar mensaje y foto de un incidente y comprender el umbral de tres pasajeros en cinco minutos.
4. Activar el pánico del conductor sin exigirle evidencia ni aprobación.
5. Revisar y aprobar/rechazar desde el rol de empresa y comprobar la prioridad del conductor.
6. Terminar el viaje por alejamiento válido y reconocer la alternativa manual.
...
**Problema #1:** [título]
**Severidad:** [1-4]
**Heurística violada:** [completar]
**Problema:** [descripción + captura]
